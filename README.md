...
# Quick start
- open /game/source/Directory.Build.Props, and change the hard coded path that is not relative that must be set:
<ProjectRoot>C:\code\GodotVisualStudioCppExtensionTemplate\</ProjectRoot>
